...
function loaded_page(){
	...
	myScroll.on('scrollEnd', function () {  
		...
		if(!!window['isIscroll5_hideHead']){
			var mainPage = $('#wrapper'),hideHead = $('#hideHead'),mh = mainPage.height(),hasHeight=hideHead.height();
